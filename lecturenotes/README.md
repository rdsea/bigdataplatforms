...
* **Programming Models for Data Processing**: (download [PDF](pdfs/module3-lecture5-programmingmodels-v0.7.pdf)), [The MapReduce Programming Model](../2024/lecturenotes/pdfs/module3-mapreduce-v0.5.pdf))
...
* **Workflows for Big Data Platforms**: (download [PDF](pdfs/module3-lecture6-workflows-v0.7.pdf))
...
* **Stream Processing and Big Data Platforms**: (download [PDF](pdfs/module3-lecture7-dataprocessing-streaming-v0.7.pdf))
* **Apache Flink for Stream Processing in Big Data Platforms** (download [PDF](../2025/lecturenotes/pdfs/module3-streaming-flink-v0.6.pdf))
...
* **GenAI/LLMs and Big Data Platforms**: [download PDF](pdfs/module4-lecture8-bigdatallm-v0.3.pdf)
