...
"check_constraints":[
        {
            "function_name":"hasSize",
             "threshold":3
        },
        {
            "function_name":"hasMin",
            "column_name":"SPEEDIN",
            "threshold":0
        },
        {
...
if __name__ == "__main__":
        ...
        if constraint["function_name"] in dir(check):
            ...
            if "threshold" in constraint.keys():
                ...
                if "column_name" in constraint.keys():
                    func(column=constraint["column_name"],
    ...
    dq_check_result = VerificationSuite(spark) \
                        .onData(input_df) \
                        .addCheck(check) \
                        .run()
    dq_check_result_df = VerificationResult.checkResultsAsDataFrame(spark, dq_check_result)
