...
''''
Get redis connection, you can use a free redis instance from redislab. You can also deploy your own redis instance.
'''
redis = Redis(os.getenv('REDIS_HOST'), int(os.getenv('REDIS_PORT')), password=os.getenv('REDIS_PASSWORD'))
